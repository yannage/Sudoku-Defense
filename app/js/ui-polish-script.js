...
(function() {
    ...
    function addOrientationSupport() {
        ...
        // Also listen for resize events to catch changes in browser windows
    ...
    function checkOrientation() {
        ...
        // Apply different layout based on orientation
        ...
        if (isPortrait) {
            ...
            if (towerSelection) {
                // More compact tower selection in portrait
            ...
            if (leftColumn && middleColumn && rightColumn) {
                ...
                // Adjust size of mission control in portrait
            ...
            if (towerSelection) {
                // Default tower selection in landscape
                towerSelection.style.gridTemplateColumns = 'repeat(3, 1fr)';
            }
